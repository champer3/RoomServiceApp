...
function PaymentsDisplay() {
   const cards  = [{card: 'Mastercard', number: '5312'}, 
   {card: 'Visa', number : '4242'},
]
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
        ...
        <View style={styles.recommendedView}>
           {cards.map(({card, number}, idx) => <View  key={idx}><Pressable><CreditCard card={card} number={number}/></Pressable></View>)}
            </View>
