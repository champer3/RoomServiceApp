            ...
            <Marker coordinate={driver} anchor={{ x: 0.5, y: 0.5 }}>
              <View style={styles.driverPinOuter}>
                <View style={styles.driverPinInner}>
                  <Ionicons name="bicycle" size={11} color={ACCENT} />
                </View>
              </View>
            </Marker>
          )}
...
const styles = StyleSheet.create({
  ...
  destPinOuter: { width: 29, height: 29, borderRadius: 15, backgroundColor: "rgba(188,108,37,0.18)", alignItems: "center", justifyContent: "center" },
  destPinInner: { width: 22, height: 22, borderRadius: 11, backgroundColor: ACCENT, alignItems: "center", justifyContent: "center", borderWidth: 2, borderColor: "#fff", shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.3, shadowRadius: 4, elevation: 5 },
  destPinTail: { width: 2, height: 7, backgroundColor: ACCENT, borderBottomLeftRadius: 2, borderBottomRightRadius: 2, marginTop: -1 },

  driverPinOuter: { width: 27, height: 27, borderRadius: 14, backgroundColor: "rgba(40,54,24,0.15)", alignItems: "center", justifyContent: "center" },
  driverPinInner: { width: 21, height: 21, borderRadius: 10, backgroundColor: "#fff", alignItems: "center", justifyContent: "center", borderWidth: 1.5, borderColor: ACCENT, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.2, shadowRadius: 3, elevation: 4 },
