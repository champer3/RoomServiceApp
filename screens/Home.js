    ...
    <SafeAreaProvider>
      ...
      <GestureHandlerRootView style={{ flex: 1, }}>
        <LinearGradient
          ...
          >
            <SafeAreaView onTouchStart={() => { ref?.current?.scrollTo(0); setBlink(true) }} style={{ height: 180}}>
              <View
                style={[styles.top, {
                  flexDirection: "row",
              ...
              >
                ...
                {<View style={{ justifyContent: 'center' }}>
                  <Text style={{ color: 'white', fontSize: 20, fontFamily: 'Poppins-Medium', }}> {greeting} {data.firstName}</Text>
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 15 }}></View>
                  <View style={{ justifyContent: 'space-between', alignItems: 'center', flexDirection: 'row', marginTop: 4}}>
                      {<Text
                        style={{
                          color: "white",
                          fontSize: 12,
                      ...
                      >
                        {address ? address?.address : <Pressable style={{flexDirection: "row",alignItems: "center", justifyContent: "flex-start"}} onPress={() => {navigation.navigate("Address")}}><Entypo name="location-pin" size={24} color="white" /><Text style={{color: "white",
                          fontSize: 12,
                          fontFamily: 'Poppins-Bold',
                          width: 250,
                          letterSpacing: 1,}}>Where should we send your order?</Text></Pressable>}
                      </Text>}
              ...
              >
                ...
                <EvilIcons name="search" size={24}  color="black" />
                  <Text
                    style={{ color: "black", fontSize: 16, fontFamily: 'Poppins-Medium', }}
          ...
          {blink && deliveringOrdersCount > 0 && 
          <TransparentSheet ref={reg}>
